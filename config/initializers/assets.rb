...
Rails.application.config.assets.precompile += %w( product_form_tags.js )
Rails.application.config.assets.precompile += %w( product_edit_form.js )
Rails.application.config.assets.precompile += %w( user_rental_status.js )
